...
import {
  ArrowRight, ArrowLeftRight, Globe, RefreshCw,
  DollarSign, Euro, PoundSterling, IndianRupee,
  HeadphonesIcon, Loader2, CheckCircle
} from 'lucide-react';
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
            ...
            <p className='text-lg sm:text-xl text-zinc-700 max-w-2xl mt-6 leading-relaxed'>
              ...
              Compare global values and make smarter financial decisions with ease.
            </p>
          </motion.div>
        </div>
              ...
              <div className='bg-zinc-50 border border-zinc-100 p-8 lg:p-10'>
                ...
                <div className='grid sm:grid-cols-5 gap-4 items-end mb-6'>
                  <div className='sm:col-span-2'>
                    <label className='block text-sm font-medium text-zinc-700 mb-1.5'>From</label>
                    <select
                      value={fromCurrency}
                ...
                {loading && (
                  <div className='flex items-center justify-center gap-2 py-8'>
                    ...
                    <span className='text-sm text-zinc-500'>Loading rates...</span>
                  </div>
                )}
                ...
                {lastUpdated && !error && (
                  <div className='flex items-center justify-between mt-4 text-xs text-zinc-500'>
                    <span>
                      Rates updated: {new Date(lastUpdated).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                      })}
            ...
            >
              <div className='bg-zinc-50 border border-zinc-100 p-8 lg:p-10'>
                ...
                <p className='text-sm text-zinc-700 mb-6'>
                  Commonly used currency pairs for international shipping and trade.
                </p>
                    ...
                    return (
                      ...
                      >
                        <div className='text-left'>
                          <p className='text-sm font-medium text-zinc-900'>{pair.label}</p>
        ...
        <div className='max-w-7xl mx-auto px-6 lg:px-8 text-center'>
          <motion.div {...fadeIn}>
            ...
            <p className='text-zinc-700 max-w-lg mx-auto mb-10 text-lg'>
              Get instant quotes, real-time tracking, and competitive exchange rates for all your international shipping needs.
            </p>
