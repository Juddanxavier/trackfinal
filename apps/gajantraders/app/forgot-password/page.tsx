      ...
      >
        ...
        >
          <div className="bg-white/[0.03] border border-white/10 backdrop-blur-xl rounded-3xl p-10 shadow-2xl text-center">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center gap-2 py-3 bg-primary hover:bg-[#172554] text-white font-semibold rounded-xl transition-all duration-200 w-full"
            >
              Back to Sign In
            </Link>
          </div>
