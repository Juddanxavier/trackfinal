        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-zinc-700 max-w-2xl mt-6 leading-relaxed">
              Find answers to common questions about our international courier
              and cargo services. Can&apos;t find what you&apos;re looking for?
          ...
          <div className="flex gap-8 lg:gap-12 flex-col lg:flex-row">
            ...
            <aside className="lg:w-72 shrink-0">
              <div className="lg:sticky lg:top-32">
                ...
                <p className="text-sm text-zinc-500 uppercase tracking-widest mb-3 font-medium">
                  Categories
                </p>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeIn}>
            ...
            <p className="text-zinc-700 max-w-lg mx-auto mb-10 text-lg">
              Get in touch with our team for personalized support. We&apos;re
