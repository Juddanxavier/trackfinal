    ...
    <div className="min-h-screen flex" style={{ backgroundColor: "#131818" }}>
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 50%, rgba(255, 191, 101, 0.15) 0%, transparent 50%)",
          }}
        />
          ...
          >
            <div className="flex -space-x-2">
              {["JD", "AS", "RK", "MK"].map((initials, i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full bg-primary/60 border-2 border-[#131818] flex items-center justify-center text-xs font-bold text-white"
                >
                  {initials}
                </div>
              ))}
          ...
          <div className="bg-white/[0.03] border border-white/10 backdrop-blur-xl rounded-3xl p-10 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div
                  className={`flex items-center gap-2 text-sm ${password.length >= 8 ? "text-green-400" : "text-white/30"}`}
                >
                  <CheckCircle className="w-4 h-4" />
                  At least 8 characters
                </div>
                <div
                  className={`flex items-center gap-2 text-sm ${/[A-Z]/.test(password) ? "text-green-400" : "text-white/30"}`}
                >
                  <CheckCircle className="w-4 h-4" />
                  One uppercase letter
                </div>
                <div
                  className={`flex items-center gap-2 text-sm ${/[0-9]/.test(password) ? "text-green-400" : "text-white/30"}`}
                >
                  <CheckCircle className="w-4 h-4" />
                  One number
                </div>
