...
export default function ProfilePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      setError("");
      const res = await api.patch<ProfileData>("/auth/profile", {
        name,
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-10">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-white border border-zinc-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-zinc-900">
                        {display.emailVerified ? "Verified" : "Pending"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-white border border-zinc-100">
                ...
                <form
                  onSubmit={handleSave}
                  className="space-y-5 bg-white border border-zinc-100 p-8"
                >
