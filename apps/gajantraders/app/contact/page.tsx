        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-zinc-700 max-w-2xl mt-6 leading-relaxed">
              Have a question about shipping, need a quote, or just want to say
            ...
            >
              <div className="bg-zinc-50 border border-zinc-100 p-8 lg:p-10 space-y-8">
                <div>
                  ...
                  <a
                    href="tel:+919003372780"
                    className="block text-base font-semibold text-zinc-900 hover:text-primary transition-colors"
                  >
                    +91 90033 72780
                  </a>
                  <a
                    href="tel:+919566156719"
                    className="block text-base font-semibold text-zinc-900 hover:text-primary transition-colors mt-1"
                  >
                    +91 95661 56719
                  </a>
                ...
                <div>
                  ...
                  <a
                    href="mailto:trichy@gajantraders.com"
                    className="block text-base font-semibold text-zinc-900 hover:text-primary transition-colors mt-1"
                  >
                    trichy@gajantraders.com
                  </a>
                  <p className="text-sm text-zinc-700 mt-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-700 leading-relaxed">
                    No 18, 3rd Main Road, Srinivasa Nagar,
                    <br />
                    Vayalur Road, Trichy 620017,
                    <br />
                    Tamil Nadu, India
                  </p>
                  <a
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeIn}>
            ...
            <p className="text-zinc-700 max-w-lg mx-auto mb-10 text-lg">
              Join thousands of businesses that trust Gajan Traders for their
