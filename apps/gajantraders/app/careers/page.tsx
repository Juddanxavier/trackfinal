...
const values = [
  {
    ...
    desc: "Every decision guided by what's best for the customer.",
  },
  {
    icon: Target,
    title: "Integrity & Transparency",
    desc: "Honesty and openness at every level.",
  },
  {
    icon: Zap,
    title: "Speed & Reliability",
    desc: "Fast, consistent, and without compromise.",
  },
  {
    icon: Star,
    title: "Innovation & Excellence",
    desc: "Pushing boundaries for smarter logistics.",
  },
];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-zinc-700 max-w-2xl mt-6 leading-relaxed">
                Build your future with global logistics leaders. Join our
                growing team and shape the future of international shipping.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div {...fadeIn} className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-base text-zinc-700 leading-relaxed max-w-lg mx-auto">
              We&apos;re always on the lookout for talented individuals. Submit
              your profile and be the first to know when the right opportunity
              opens up.
            </p>
            <Link
              href="mailto:careers@gajantraders.com"
