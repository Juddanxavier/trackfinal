        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-zinc-700 max-w-2xl mt-6 leading-relaxed">
              Trusted Global Courier Partner orchestration global commerce with
              surgical precision and unmatched speed.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-3 bg-white border border-zinc-100 shadow-sm">
            {[
              ...
              <div
                key={i}
                className="p-6 lg:p-8 text-center border-r border-zinc-100 last:border-r-0"
              >
                <s.icon className="w-6 h-6 text-primary mx-auto mb-3" />
                <div className="text-xl lg:text-2xl font-semibold text-zinc-900">
                  {s.value}
                </div>
                <div className="text-sm text-zinc-400 mt-1 uppercase tracking-wider">
                  {s.label}
                </div>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeIn}>
              ...
              <div className="space-y-4 text-lg text-zinc-700 leading-relaxed">
                <p>
                  Gajan Traders is committed to delivering reliable, efficient,
                  and globally connected shipping solutions. We bridge the gap
                  between Indian businesses and international markets with
                  precision and care.
                </p>
                <p className="text-zinc-400">
                  With an extensive network across India, operations are driven
                  by precision, consistency, and a strong focus on service
                  excellence. Every shipment is handled with care, ensuring
                  seamless movement across international destinations.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div {...fadeIn} className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-lg text-zinc-700 leading-relaxed">
                <p>
                  Comprehensive logistics solutions are designed to meet the
                  dynamic needs of individuals and businesses.
                </p>
                <p className="text-zinc-400">
                  Services include International shipping, enabling smooth and
                  secure transportation of documents, parcels, and high-value
                  consignments. Each shipment is managed with a focus on timely
                  delivery, secure handling, and a streamlined customer
                  experience.
                </p>
              </div>
            </motion.div>
              ...
              {[
                {
                  year: "2018",
                  title: "The Beginning",
                  desc: "A single office marked the start of a larger vision — to simplify international shipping and create seamless global connections for businesses and individuals.",
                },
                {
                  year: "2020",
                  title: "Digital Transformation",
                  desc: "Launched real-time tracking and digital booking platforms, enabling customers to manage shipments entirely online.",
                },
                {
                  year: "2022",
                  title: "Network Expansion",
                  desc: "Expanded operations to 25+ countries with strategic partnerships, opening new trade corridors for our customers.",
                },
                {
                  year: "2024",
                  title: "Scale & Innovation",
                  desc: "Crossed 10,000 successful shipments. Introduced automated customs documentation and AI-powered route optimization.",
                },
                {
                  year: "2026+",
                  title: "The Future",
                  desc: "Continuing to expand our global footprint with a focus on technology-driven efficiency and sustainable logistics practices.",
                },
              ].map((t, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-base text-zinc-700 mt-1 leading-relaxed">
                      {t.desc}
                    </p>
                  </div>
                </motion.div>
            ...
            {[
              {
                ...
                desc: "Strategic partnerships with global carriers and local delivery fleets across 50+ countries.",
              },
              {
                icon: Shield,
                title: "Secure Logistics",
                desc: "Multi-layered security protocols and comprehensive transit insurance for peace of mind.",
              },
              {
                icon: HeadphonesIcon,
                title: "Dedicated Support",
                desc: "Human-led assistance for every shipping query, from booking to final delivery.",
              },
              {
                icon: Clock,
                title: "Real-Time Tracking",
                desc: "Live IoT-based tracking with milestone alerts and proactive status updates.",
              },
            ].map((e, i) => (
              <motion.div
                key={i}
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <motion.div {...fadeIn}>
            ...
            <p className="text-zinc-700 max-w-lg mx-auto mb-10 text-lg">
              Experience the precision and velocity that thousands of businesses
              trust every day.
            </p>
