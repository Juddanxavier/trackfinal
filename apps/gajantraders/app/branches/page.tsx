...
import {
  ...
  Globe, Star, ChevronRight, Navigation, HeadphonesIcon,
  Package, Shield, Search, X
} from 'lucide-react';
    ...
    <div className='min-h-screen bg-white'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
              ...
              <p className='text-lg sm:text-xl text-zinc-700 max-w-2xl mt-6 leading-relaxed'>
                With {branches.length} locations across Tamil Nadu serving local and international shipping needs.
                Visit any branch for international shipping, tracking support, and expert guidance.
              </p>
            ...
            >
              <WorldMap size={520} markers={branchMarkers} markerColor={[0.9, 0.2, 0.16]} arcs={[]} phi={1.2} theta={0.4} />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      {headOffice && (
        <section className='py-14 lg:py-20'>
          <div className='max-w-7xl mx-auto px-6 lg:px-8'>
            <motion.div {...fadeIn} className='text-center max-w-xl mx-auto mb-12'>
              <span className='text-primary text-sm font-semibold tracking-[0.2em] uppercase block mb-4'>Head Office</span>
              ...
              <div className='grid lg:grid-cols-5'>
                <div className='lg:col-span-3 p-8 md:p-10'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <div>
                      <h3 className='text-lg font-semibold text-zinc-900'>{headOffice.city}</h3>
                  ...
                  <div className='grid sm:grid-cols-2 gap-6'>
                    <div className='space-y-4'>
                        ...
                        <p className='text-base text-zinc-700 leading-relaxed'>{headOffice.address}</p>
                      </div>
                      <a href={`tel:${headOffice.phone.replace(/\s/g, '')}`} className='flex items-center gap-3 text-base text-zinc-700 hover:text-primary transition-colors'>
                        <Phone className='w-4 h-4 text-primary shrink-0' />
                        <span>{headOffice.phone}</span>
                      </a>
                      <a href={`mailto:${headOffice.email}`} className='flex items-center gap-3 text-base text-zinc-700 hover:text-primary transition-colors'>
                    ...
                    <div>
                      <h4 className='text-sm font-semibold text-zinc-700 uppercase tracking-wider mb-3'>Why Gajan Traders</h4>
                      <ul className='space-y-2.5'>
                        {[
                          ...
                          <li key={i} className='flex items-center gap-2 text-base text-zinc-700'>
                ...
                <div className='lg:col-span-2 bg-gradient-to-br from-primary/5 to-primary/[0.02] p-8 md:p-10 flex items-center justify-center border-t lg:border-t-0 lg:border-l border-zinc-200'>
                  <div className='text-center'>
                    ...
                    <h4 className='text-base font-semibold text-zinc-900 mb-2'>Global Reach, Local Presence</h4>
                    <p className='text-sm text-zinc-700 leading-relaxed max-w-xs mx-auto'>
                      From our Trichy main office, we coordinate international shipments across 200+ countries with 4 branch offices serving Tamil Nadu.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className='pb-14 lg:pb-20'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <motion.div {...fadeIn} className='text-center max-w-xl mx-auto mb-12'>
            <span className='text-primary text-sm font-semibold tracking-[0.2em] uppercase block mb-4'>Our Branches</span>
            <h2 className='text-xl sm:text-2xl lg:text-3xl font-semibold text-zinc-900 leading-[0.95] tracking-tight font-heading'>
              All locations
            </h2>
          </motion.div>
          ...
          {otherBranches.length === 0 ? (
            <div className='text-center py-20'>
              ...
              <p className='text-base font-semibold text-zinc-700'>No branches found</p>
              <p className='text-base text-zinc-400 mt-1'>Try adjusting your search or filter</p>
              <button
                onClick={() => { setActiveState('All'); setSearchQuery(''); }}
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6'>
              {otherBranches.map((branch, i) => (
                ...
                >
                  ...
                  <h3 className='text-lg font-semibold text-zinc-900 mb-1'>{branch.city}</h3>
                  <p className='text-sm text-zinc-700 leading-relaxed mb-5 line-clamp-2'>{branch.address}</p>
      ...
      <section className='py-14 lg:py-20 bg-zinc-50'>
        <div className='max-w-7xl mx-auto px-6 lg:px-8'>
          <div className='text-center max-w-xl mx-auto mb-16'>
            <span className='text-primary text-sm font-semibold tracking-[0.2em] uppercase block mb-4'>Branches FAQ</span>
            <h2 className='text-xl sm:text-2xl lg:text-3xl font-semibold text-zinc-900 leading-[0.95] tracking-tight font-heading'>
          ...
          <div className='max-w-3xl mx-auto space-y-3'>
            {[
              { q: 'Does Gajan Traders have branches across India?', a: 'Yes — we have branches in Trichy, Salem, and Chennai (Royapuram & Saidapet). Visit any branch for international courier booking, tracking support, and packaging services.' },
              { q: 'Do you offer doorstep pickup?', a: 'Yes — we offer free doorstep pickup across all serviceable locations. Schedule a pickup online through our website or call your nearest branch directly.' },
              { q: 'What services are available at your branches?', a: 'Our branches offer international courier booking, tracking support, pickup assistance, free packaging, customs documentation guidance, and dedicated customer support.' },
              { q: 'What are your branch working hours?', a: 'All branches operate Monday to Saturday, 9:30 AM to 6:30 PM. Sunday is closed.' },
            ].map((faq, i) => (
              <div
                key={i}
        ...
        <div className='relative max-w-7xl mx-auto px-6 lg:px-8 text-center'>
          <motion.div {...fadeIn}>
            ...
            <p className='text-zinc-700 max-w-lg mx-auto mb-10 text-lg'>
              Schedule a free home pickup and we will handle the rest. No branch visit needed.
            </p>
