...
function ThreeDIcon({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`relative rounded-lg flex items-center justify-center ${iconClass}`}
...
const prohibitedItems = [
  {
    ...
    label: "Currency",
    description:
      "Shipping of currency, cash, or monetary instruments is strictly prohibited.",
    image:
      "https://images.unsplash.com/photo-1579621970563-449ec4c1b0a4?w=400&q=80",
  },
  {
    icon: Flame,
    label: "Hazardous",
    description:
      "Hazardous or dangerous goods including explosives, gases, and flammable materials are not allowed.",
    image:
  ...
  },
  {
    ...
    label: "Valuables",
    description:
      "Precious & semi-precious items including gold, silver, diamonds, and gemstones are prohibited.",
    image:
  ...
  },
  {
    ...
    label: "Legal",
    description:
      "Legally restricted items such as narcotics, firearms, and counterfeit goods are not permitted.",
    image:
      "https://images.unsplash.com/photo-1616077168070-5cb5f5f0a3f0?w=400&q=80",
  },
  {
    icon: AlertTriangle,
    label: "Shipment Risk",
    description:
      "Shipments posing risk of damage or delay to other consignments are not accepted.",
    image:
  ...
  },
  {
    ...
    label: "Liquids",
    description:
      "Liquids and semi-liquids including oils, paints, and chemicals are prohibited.",
    image:
      "https://images.unsplash.com/photo-1587905064218-f2c91f2e0e20?w=400&q=80",
  },
  {
    icon: Gavel,
    label: "Regulatory",
    description:
      "Goods banned by local or international law may not be shipped under any circumstances.",
    image:
  ...
  },
  {
    ...
    label: "Perishable",
    description:
      "Perishable food items, beverages, and temperature-sensitive goods are not allowed.",
    image:
      "https://images.unsplash.com/photo-1556845334-d23d8f0e5e1b?w=400&q=80",
  },
  {
    icon: PawPrint,
    label: "Living",
    description:
      "Shipping of live animals, plants, or biological specimens is strictly prohibited.",
    image:
      "https://images.unsplash.com/photo-1545249390-291516c1d2b0?w=400&q=80",
  },
];
...
const categories = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1580795483976-0f05c0e4bc87?w=600&q=80",
  },
  {
    label: "Valuables & Currency",
    items: [
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-zinc-700 max-w-2xl mt-6 leading-relaxed">
                To maintain safe and compliant logistics, certain items cannot
                be shipped. These restrictions protect people, goods, and
                operations. Please ensure your shipment meets the guidelines
                before booking.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row-reverse gap-10 lg:gap-16 items-center">
            <motion.div {...fadeIn} className="flex-1">
              <p className="text-base text-zinc-500 uppercase tracking-widest mb-2 font-medium">
                Why It Matters
              </p>
              ...
              <p className="text-base text-zinc-700 mt-4 leading-relaxed">
                International shipping regulations exist to protect everyone
                involved in the logistics chain — from our pickup team to
                airline crew to the final recipient. Violating these rules can
                result in severe penalties, legal action, and safety hazards.
              </p>
              ...
              >
                <div className="relative h-36 overflow-hidden rounded-t-lg">
                  ...
                  <div className="absolute bottom-3 left-3 flex items-center gap-2">
                    <ThreeDIcon
                      icon={item.icon}
                      iconClass="w-9 h-9 bg-gradient-to-br from-red-500 to-red-600 text-white shadow-lg"
                    />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div {...fadeIn}>
            ...
            <p className="text-base text-zinc-700 mt-4 max-w-3xl leading-relaxed">
              Below is a comprehensive classification of items that cannot be
              shipped through our services. This list is not exhaustive and may
                ...
                <div className="p-4">
                  <ul className="space-y-2">
                    {cat.items.map((item) => (
                      <li
                        key={item}
                        className="flex items-start gap-2 text-base text-zinc-700"
                      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <motion.div {...fadeIn}>
              ...
              <p className="text-base text-zinc-700 mt-4 leading-relaxed">
                Shipping prohibited items can have serious consequences.
                Understanding these risks helps ensure compliance and avoids
                penalties.
              </p>
              <div className="mt-6 space-y-4">
                {[
                  {
                    icon: FileWarning,
                    label: "Shipment Confiscation",
                    desc: "Prohibited items found in transit will be seized and destroyed by authorities without compensation.",
                  },
                  {
                    icon: XCircle,
                    label: "Legal Penalties",
                    desc: "Violating shipping regulations can result in fines, legal action, and criminal charges depending on jurisdiction.",
                  },
                  {
                    icon: Ban,
                    label: "Account Suspension",
                    desc: "Repeated violations may lead to permanent suspension of your shipping account with Gajan Traders.",
                  },
                  {
                    icon: ClipboardList,
                    label: "Customs Blacklisting",
                    desc: "Frequent violations can result in your shipments being flagged for increased scrutiny by customs authorities.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-4 bg-white border border-zinc-100"
                  >
                    <ThreeDIcon
                      icon={item.icon}
                      iconClass="w-9 h-9 bg-red-50 text-red-500"
                    />
                    <div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <motion.div {...fadeIn}>
              ...
              <p className="text-base text-zinc-700 mt-4 leading-relaxed">
                Our support team can help you determine if your shipment meets
                all regulatory requirements before you book. We&apos;re
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-center gap-3">
                  <ThreeDIcon
                    icon={Mail}
                    iconClass="w-9 h-9 bg-primary/10 text-primary"
                  />
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <ThreeDIcon
                    icon={Phone}
                    iconClass="w-9 h-9 shrink-0 [&>div]:bg-primary/10 [&>div]:text-primary"
                  />
                  <div>
                    <p className="text-sm text-zinc-500 uppercase tracking-wider">
                      Phone
