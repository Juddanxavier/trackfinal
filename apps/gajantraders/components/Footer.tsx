...
const contactDetails = [
  {
    icon: MapPin,
    text: "7, Gajan Traders House, P D Mello Road, Near Masjid Bunder, Mumbai 400009",
  },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
            ...
            >
              <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
                ...
                <span className="text-xl font-semibold text-white tracking-tight font-heading">
                  {company.name}
                </span>
              </Link>
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              >
                ...
                <button
                  type="submit"
                  className="flex items-center gap-2 px-5 py-2.5 text-white text-sm font-semibold rounded-lg transition-all active:scale-95 shrink-0"
